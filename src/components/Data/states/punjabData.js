export const punjabData = {
    hero: {
        ...
        basePath: "/pilot-training-in-punjab",
    },

    menuItems: [
        { name: "Overview", path: "/pilot-training-in-punjab" },
        { name: "Courses", path: "/pilot-training-in-punjab/courses" },
        { name: "Eligibility", path: "/pilot-training-in-punjab/eligibility" },
        { name: "Fees", path: "/pilot-training-in-punjab/fees" },
    ],
    ...
    sections: [
        ...
        // ------------------ COURSES ----------------------
        {
            ...
            paragraphs: [
                "We offer all major pilot training programs at our academy in Punjab.",
            ],
            list: [
                {
                    title: "Commercial Pilot Training (CPL)",
                    text: "Duration: 12–18 months | Aircraft: Cessna 172 Glass Cockpit | Includes 200+ flying hours, DGCA exam preparation & career training.",
                },
                {
                ...
                },
                {
                    ...
                    text: "Duration: 3–4 months | Aircraft: Cessna 172 Glass Cockpit | Advanced training under real aviation conditions.",
                },
            ],
        },
        ...
        // ------------------ SYLLABUS ----------------------
        {
            ...
            paragraphs: [
                "A detailed breakdown of the essential CPL syllabus:",
            ],
            list: [
                { title: "Air Regulations", text: "Aviation rules, legal procedures and airspace guidelines." },
                { title: "Aviation Meteorology", text: "Weather patterns, storms, winds, clouds & their effect on flying." },
                { title: "Air Navigation", text: "Route planning, map reading, instruments & navigation systems." },
                { title: "Technical General", text: "Aircraft systems, engines, structures, and overall technology." },
                { title: "Technical Specific", text: "Detailed study of the specific aircraft you will fly." },
                { title: "Radio Telephony", text: "Communication techniques used with ATC and other aircraft." },
            ],
        },
        ...
        // ------------------ FEES ----------------------
        {
            ...
            paragraphs: [
                "Average pilot training fees in Punjab range between INR 40–50 lakhs. This includes:",
            ],
            list: [
                { title: "Ground Classes", text: "₹2–5 lakhs — aviation subjects & DGCA study material." },
                { title: "Flying Hours", text: "₹35–45 lakhs — includes 200+ flying hours." },
                { title: "Simulator Training", text: "₹3–5 lakhs — practice flying on advanced simulators." },
                { title: "Other Essentials", text: "₹1–2 lakhs — books, uniforms, medicals, exams & additional charges." },
            ],
        },
        ...
        // ------------------ WHY FEES CHANGE ----------------------
        {
            ...
            list: [
                ...
                { title: "Aircraft Type", text: "Better aircraft = higher training fees." },
                { title: "Add-on Training", text: "Night flying or multi-engine training increases cost." },
            ],
        },
        ...
        // ------------------ HOW TO CHOOSE INSTITUTE ----------------------
        {
            ...
            list: [
                ...
                { title: "Flexible Payment Options", text: "Choose institutes with student-friendly payment plans." },
                { title: "Scholarships & Loan Support", text: "Availability of scholarships and financial support is a plus." },
            ],
        },
        ...
        // ------------------ WHY WE ONE ----------------------
        {
            ...
            paragraphs: [
                "We One Aviation Academy is a premier aviation institute in Punjab with 3000+ trained pilots.",
            ],
            list: [
                { title: "Scholarships Available", text: "Financial assistance for deserving students." },
                { title: "Flexible Fee Structure", text: "Affordable and flexible payment plans." },
                { title: "Experienced Teachers", text: "Highly skilled aviation experts and instructors." },
                { title: "Modern Infrastructure", text: "Well-equipped training facilities and classrooms." },
                { title: "Free 200 Hours Simulator Training", text: "Boost your skills with extensive simulator flying." },
                { title: "Study Library", text: "Access to aviation study materials." },
                { title: "Limited Seats", text: "Apply early to secure your seat." },
            ],
        },
        ...
        // ------------------ USA TRAINING BENEFITS ----------------------
        {
            ...
            paragraphs: [
                "Join We One Aviation and enjoy exclusive USA flight training benefits.",
            ],
            list: [
                { title: "40-Hour PPL Challenge", text: "Complete PPL before 40 hours & get IR training free." },
                { title: "FAA-Approved Flying School", text: "Train at an international airport with global standards." },
                { title: "Accommodation Near Airport", text: "Comfortable stay provided for all students." },
                { title: "Full Scholarship After CPL", text: "Eligible students can receive full scholarship for advanced training." },
                { title: "1500-Hour Flight Building Free", text: "Build required airline hours at no extra cost." },
                { title: "Advanced Aircraft", text: "Train on modern Cessna 172 Glass Cockpit aircraft." },
            ],
        },

        {
            ...
            list: [
                ...
                { title: "Ideal Weather Conditions", text: "More flying days = faster course completion." },
                { title: "Direct Airline Pathway", text: "Structured training for guaranteed airline roles." },
            ],
        },
    ],
};
