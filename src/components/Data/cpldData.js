export const cplData = {
    ...
    sections: [
        {
            title: "What is a Commercial Pilot License (CPL)?",
            description:
            ...
            subsections: [
                {
                    heading: "CPL Full Form in Hindi",
                    list: ["CPL का फुल फॉर्म है: कमर्शियल पायलट लाइसेंस"],
                },
            ],
        },

        {
            title: "Basic Eligibility Criteria for CPL in India",
            subsections: [
                {
                ...
                {
                    heading: "2. Educational Qualification",
                    list: [
                ...
                {
                    heading: "3. Minimum Flying Requirements",
                    list: [
        ...
        {
            title: "DGCA Medical Requirements for CPL",
            description:
            ...
            subsections: [
                {
                    heading: "Class 1 Medical Includes:",
                    list: [
        ...
        {
            title: "Steps to Become a Commercial Pilot",
            subsections: [
                {
                    list: [
        ...
        {
            title: "CPL Ground Subjects (DGCA Syllabus)",
            subsections: [
                {
                    list: [
                        "Air Navigation",
        ...
        {
            title: "Why Choose CPL as a Career?",
            subsections: [
                {
                    list: [
